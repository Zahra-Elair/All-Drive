...
type Drive = "Google Drive" | "One Drive" | "Dropbox Files" | "Mega Drive";
...
const DriveCard: FC<DriveCardProps> = ({ type, files, maxStorage, usedStorage }) => {
  ...
  return (
    <div className=" bg-white border border-r-gray-300 py-6 px-4 rounded">
      ...
      <p className=" text-primary text-lg tracking-widest mb-1 font-medium">{driveCaracteristics.name}</p>
      ...
      <div className=" text-center">
        ...
        <PourcentageBar pourcentage={pourcentage} color={driveCaracteristics.color} />
      </div>
    </div>
  );
};
